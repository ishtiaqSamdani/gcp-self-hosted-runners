...
const AccountingPage = () => {
  ...
  }, [categoryRule.isModalOpen, merchantRule.isModalOpen]);
  ...
  const onCreateCategoryRuleClick = () => {
    setCategoryRule((prevCategoryRule) => ({
      ...prevCategoryRule,
      isModalOpen: true,
    }));
  ...
  return (
    <ContentStack>
      <HeaderStack>
        ...
        <ButtonStack>
          ...
          <Button
            ...
            width="130px"
            onClick={onCreateCategoryRuleClick}
          />
        </ButtonStack>
      </HeaderStack>
      <StyledCounterStack>
      ...
      {categoryRule.isModalOpen && (
        <RuleModalWrapper>
          <CreateCategoryRule handleCancelClick={onCategoryRuleCancelClick} />
        </RuleModalWrapper>
      )}
    </ContentStack>
  );
